...
As the values being retrieved from Bonita Runtime, usual xref:{bonitaVersion}@bonita::performance-tuning.adoc[perfomance tuning] actions described for Bonita Runtime are applicable. 
