...
```bash
docker image pull bonitasoft.jfrog.io/docker-release-local-sp/bonita-central:1.0.0-Beta-01
```
...
docker container run -d --name my-bonita-central \
    ...
    bonitasoft.jfrog.io/docker-release-local-sp/bonita-central:1.0.0-Beta-01
```
